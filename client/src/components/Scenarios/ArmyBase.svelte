...
{#if showOptions}
    <div class="options-container">
        <ScenarioOption unlocked={true} text="INTELLECT: Forage." eventHandler={() => forageHandler()}/>
        <ScenarioOption unlocked={true} text="STRENGTH: Punch a tree." eventHandler={() => punchHandler()}/>
    </div>           
{/if}        
